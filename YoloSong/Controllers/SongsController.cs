...
namespace YoloSong.Controllers
{
    public class SongsController : Controller
    {
        ...
        {
            // lấy danh sách category trả về form cho người dùng chọn.
        ...
        {
            // Lấy danh sách category id khi người dùng check thông qua mảng categoriesId.
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Song song, int[] categoriesId)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    {
                        Category cate = _context.Categories.Find(item);
                        SongCategory songCategory = new SongCategory
                        {
                            Category = cate,
                            Song = song
